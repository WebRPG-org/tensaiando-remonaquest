...
(function () {
    ...
    const params = {
        ...
        MeronatextColor: asNumber(parameters, 'メロナカラー', 'MeronatextColor'),
        RemonatextColor: asNumber(parameters, 'レモナカラー', 'RemonatextColor'),
        PurunatextColor: asNumber(parameters, 'プルナカラー', 'PurunatextColor'),
        McsakitextColor: asNumber(parameters, 'MCサキカラー', 'McsakitextColor')
    };
    class Window_ActorName extends Window_Base {
        ...
        refresh(text) {
            ...
            if(text=="メロナ"){
                this.changeTextColor(this.textColor(params.MeronatextColor));
            }
            if(text=="レモナ"){
                this.changeTextColor(this.textColor(params.RemonatextColor));
            }
            if(text=="プルナ"){
                this.changeTextColor(this.textColor(params.PurunatextColor));
            }
            if(text=="ＭＣサキ"){
                this.changeTextColor(this.textColor(params.McsakitextColor));
            }
