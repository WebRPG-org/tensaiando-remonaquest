 ...
 * 
 * @param button8
 * @desc PS4コントローラ：select
 * @type struct<ButtonInfo>
 * @default {"buttonName":"SHARE","action":""}
 * @parent buttons
 * 
 * @param button9
 * @desc PS4コントローラ：start
 * @type struct<ButtonInfo>
 * @default {"buttonName":"OPTIONS","action":""}
 * @parent buttons
 * 
 * @param button10
 * @desc PS4コントローラ：左スティック押し込み
 * @type struct<ButtonInfo>
 * @default {"buttonName":"L PSH","action":""}
 * @parent buttons
 * 
 * @param button11
 * @desc PS4コントローラ：右スティック押し込み
 * @type struct<ButtonInfo>
 * @default {"buttonName":"R PSH","action":""}
 * @parent buttons
 * 
 * @param moveButtons
